...
STATEFUL_SETS=$(curl -f -k https://localhost:8080/apis/apps/v1beta1/statefulsets -H "Authorization: Bearer $(cat /var/run/secrets/kubernetes.io/serviceaccount/token)")
